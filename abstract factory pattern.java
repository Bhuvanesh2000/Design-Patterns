...
// #endregion #region Pet Animal collections
    class PetDog : IDog
    {
        public void Speak()
        {
...
//Concrete Factory-Pet Animal Factory 
    ...
    class Program
    {
        ...
        { 
            ...
            wildDog.Speak(); wildDog.Action(); //Making a wild tiger through WildAnimalFactory
            ITiger wildTiger = wildAnimalFactory.GetTiger();
            wildTiger.Speak();
            wildTiger.Action(); Console.WriteLine("******************"); //Making a pet dog through PetAnimalFactory
            ...
            petTiger.Speak();
            petTiger.Action(); Console.ReadLine();
        } 
    }
}